...
Before building projects, set up your development environment.

| Guide | Description | Pages |
|-------|-------------|:-----:|
| [Project Setup](./fundamentals/project-setup/) | Terminal, Python, pip, and venv on Mac | 36 |
| [VS Code on Mac](./fundamentals/vscode-mac/) | Install, navigate, extensions, shortcuts, settings | 39 |

Complete these first if you're new to programming on Mac.
...
### Fundamentals
- [Project Setup — Foundation Guide](./fundamentals/project-setup/foundation.html)
- [VS Code on Mac — Foundation Guide](./fundamentals/vscode-mac/foundation.html)
...
├── fundamentals/           # Setup guides
│   ├── project-setup/      # Terminal, Python, pip, venv
│   └── vscode-mac/         # VS Code setup and usage
...
- **A text editor** — VS Code recommended (see our guide!)
